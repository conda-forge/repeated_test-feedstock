...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1842&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/repeated_test-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `repeated_test` can be installed with `conda`:
...
```
mamba install repeated_test
```

It is possible to list all of the versions of `repeated_test` available on your platform with `conda`:
...
```
mamba search repeated_test --channel conda-forge
```
...
mamba repoquery search repeated_test --channel conda-forge

# List packages depending on `repeated_test`:
mamba repoquery whoneeds repeated_test --channel conda-forge

# List dependencies of `repeated_test`:
mamba repoquery depends repeated_test --channel conda-forge
```
